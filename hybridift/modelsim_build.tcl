...
vlog -64 -suppress 7061 -suppress 2583 -suppress 8386 -suppress 13314 -suppress 7063 -suppress 3009 -sv -work $LIB $MODELSIM_VLOG_COVERFLAG +define+RANDOMIZE_INIT=1 +define+STOP_COND=0 -ccflags '-std=c++14' $MODELSIM_INCDIRSTR -sv $CASCADE_DIR/generated/out/$INSTRUMENTATION.sv



vlog -64 -suppress 7061 -suppress 2583 -suppress 8386 -suppress 13314 -suppress 7063 -sv -work $LIB $MODELSIM_VLOG_COVERFLAG -ccflags '-std=c++14' -sv $SV_TOP
vlog -64 -suppress 7061 -suppress 2583 -suppress 8386 -suppress 13314 -suppress 7034 -suppress 7063 -sv -work $LIB $MODELSIM_VLOG_COVERFLAG -ccflags '-std=c++14' -sv $SV_MEM
vlog -64 -suppress 7061 -suppress 2583 -suppress 8386 -suppress 13314 -suppress 7063 -sv -work $LIB $MODELSIM_VLOG_COVERFLAG -ccflags '-std=c++14' -sv $SV_TB

vlog -64 -ccflags '-std=c++14' -work $LIB $MODELSIM_VLOG_COVERFLAG -dpiheader $CASCADE_META_COMMON/dv/elf.h $CASCADE_META_COMMON/dv/elfloader.cc $CASCADE_META_COMMON/dv/common_functions.cc
